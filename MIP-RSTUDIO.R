...
#######################COMENTÁRIOS PARA ALTERAR DEPOIS##########################
...
#PARA LER O ARQUIVO XLSX VAMOS USAR O readxl, TAMBEM TEMOS O xlsx E openxls
library("readxl")
...
dimnames(MATRIZ_12_SETORES_RECURSOS) <- list(c("P1", "P2","P3", "P4", "P5", "P6", "P7","P8", "P9", "P10", "P11", "P12","VALOR_BRUTO_DA_PRODUÇÃO"),
                                             c("S1", "S2", "S3", "S4", "S5","S6", "S7", "S8", "S9", "S10","S11","S12","VALOR_PRODUÇÃO_DO_PRODUTO")) 
...
#PRODUCAO POR PRODUTO PARA EMS EGUIDA FAZER A DIVISÃO DE UMA MATRIZ POR OUTRA. E POR FIM ARREDONDO PARA 4 CASAS
